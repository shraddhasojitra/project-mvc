<?php  $mainurl="http://localhost/shraddha/project/project-mvc/";
$baseurl="http://localhost/shraddha/project/project-mvc/assets/"?>
<!DOCTYPE html>
<html lang="en">
   <head>
      <!-- basic -->
   ...
   <body class="main-layout">
      ...
      <!-- <div class="loader_bg"> -->
         <!-- <div class="loader"><img src="<?php echo $baseurl;?>images/loading.gif" alt="#"/></div> -->
      <!-- </div> -->
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="<?php echo $mainurl;?>about_us">About</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="<?php echo $mainurl;?>we_what_do">What we do</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="<?php echo $mainurl;?>priceing">Priceing</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="<?php echo $mainurl;?>contact_us">Contact Us</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="<?php echo $mainurl;?>login">Account</a>
                              </li>
                           </ul>
                        </div>
                     </nav>
